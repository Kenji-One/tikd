  ...
  return (
    <>
      <button
        ...
        onClick={onClose}
        className="fixed inset-0 z-[79] bg-black/60 backdrop-blur-[2px] md:hidden"
      />

      <div
        className={clsx(
          "z-[80] overflow-hidden border border-white/10 bg-neutral-950/55 backdrop-blur-2xl",
          ...
          "shadow-[0_28px_110px_rgba(0,0,0,0.72)] ring-1 ring-white/[0.06]",
          "fixed inset-x-3 bottom-3 top-[108px] flex flex-col rounded-[28px]",
          "md:absolute md:right-0 md:top-[calc(100%+10px)] md:bottom-auto md:left-auto md:w-[380px] md:rounded-2xl",
        )}
        role="dialog"
        aria-label="Messages"
      >
        ...
        {items.length === 0 ? (
          ...
          <div className="min-h-0 flex-1 overflow-auto p-2 no-scrollbar md:max-h-[420px]">
