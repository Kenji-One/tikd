...
export default function Landing() {
  // 1️⃣ track which category is active
  const [selectedCategory, setSelectedCategory] = useState<string>("All");

  // 2️⃣ memoize grouping for the “All” case
  ...
  // 3️⃣ grab all items when a single category is picked
  ...
  return (
    <>
      ...
      {/* carousels */}
      <main className="mx-auto w-full max-w-[1201px] px-4 py-12">
        {selectedCategory === "All" ? (
          // ─── All: render one slider per category ─────────────────────────
          ...
          // ─── Single category: show a simple grid ────────────────────────
