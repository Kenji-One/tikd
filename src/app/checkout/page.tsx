...
function OfferBanner({
  ...
  return (
    <div className="mb-4 overflow-hidden rounded-2xl">
      <div className="relative grid min-h-[160px] grid-cols-1 items-center md:grid-cols-[320px_1fr]">
        ...
        <div
          className={`relative flex h-full items-center justify-between gap-4 bg-gradient-to-r ${gradient} px-5 py-6`}
        >
          <div className="flex flex-col">
            <span className="mb-2 inline-flex items-center rounded-full bg-neutral-900/60 px-2 py-1 text-[11px] font-semibold text-primary-952 backdrop-blur">
              {badge}
            </span>
            <h3 className="max-w-[480px] text-2xl font-extrabold uppercase leading-[1.05] tracking-tight text-white md:text-[28px]">
              {title}
            </h3>
          </div>
          <button className="shrink-0 rounded-full bg-white px-4 py-2 text-sm font-semibold text-neutral-900">
            Add to cart
          </button>
        </div>
      </div>
