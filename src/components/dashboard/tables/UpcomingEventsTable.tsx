...
function MobileStat({
  ...
  return (
    <div className="rounded-xl border border-white/8 bg-white/[0.03] px-3 py-2.5">
      ...
      <div
        className={clsx(
          "mt-1 text-sm font-extrabold text-white tabular-nums",
          valueClassName,
        )}
      >
        {value}
  ...
  return (
    <div className="relative overflow-hidden rounded-lg border border-neutral-700 bg-neutral-900 py-2">
      <div className="flex items-center justify-between gap-2 border-b border-neutral-700 px-4 pb-2">
        <h3 className="text-sm font-bold uppercase text-neutral-400 sm:text-base">
          Upcoming Events
        </h3>
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="group block cursor-pointer px-4 py-3 hover:bg-neutral-800 focus:outline-none"
                  >
                    <div className="flex flex-col gap-4 sm:hidden">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="truncate text-sm font-extrabold uppercase text-white group-hover:text-white">
                            {r.title}
                          </div>
                          <div className="mt-1 line-clamp-2 text-xs font-medium text-primary-951">
                            {r.dateLabel}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <MobileStat
                          ...
                          icon={<StatIconTicket />}
                        />
                        <MobileStat label="Revenue" value={r.revenue} />
                        <MobileStat
                          label="Event Date"
                          value={r.eventDateLabel}
                    ...
                    <div
                      className={[
                        "hidden sm:grid sm:items-center",
