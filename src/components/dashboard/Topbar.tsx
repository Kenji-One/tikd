...
export default function Topbar({
  ...
  const sortLabel =
    SORT_OPTIONS.find((option) => option.key === sortBy)?.label ?? "Me";
  ...
  useEffect(() => {
    const onGlobal = (event: KeyboardEvent) => {
      ...
      const isCmdK = key === "k" && (event.metaKey || event.ctrlKey);
  ...
  const sortSelector = showSortSelector ? (
    <div ref={sortRef} className="relative w-full max-w-[126px]">
      <button
        ...
        className="flex w-full items-center justify-between rounded-full border border-white/10 bg-neutral-900 px-3 py-[9px] text-left text-white/80 outline-none transition hover:border-primary-500 hover:text-white focus-visible:border-primary-500 cursor-pointer"
      >
                ...
                {SORT_OPTIONS.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={clsx(
                        "flex w-full items-center justify-between rounded-lg px-3.5 py-2 text-left text-sm outline-none hover:bg-white/5 focus:bg-white/5",
  ...
  const searchTrigger = (
    <button
      ...
      className="group flex h-[42px] w-full sm:max-w-md items-center gap-3 rounded-full border border-white/10 bg-[#121420] px-3 text-left text-sm text-white outline-none focus-visible:border-primary-500 cursor-pointer md:h-[44px] md:px-4"
    >
  ...
  return (
    <>
      <div
        data-hide-logo={hideLogo ? "true" : "false"}
        className={clsx(
          "relative z-10",
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex flex-col gap-3 pb-5 pt-4 md:grid md:grid-cols-[minmax(0,1fr)_auto] md:items-start md:gap-5 md:pb-6">
            <div className="flex items-center justify-between gap-3 md:order-2 md:justify-end">
              {showSidebarToggle && (
                <button
                  type="button"
                  ...
                  className={clsx(
                    "grid h-[42px] w-[42px] shrink-0 place-items-center rounded-full border border-white/10 bg-[#121420] text-white md:hidden",
                    "shadow-[0_14px_34px_rgba(0,0,0,0.35)] transition",
                    "hover:border-primary-500/50 hover:bg-[#16192a]",
                  )}
                >
              ...
              <div className="ml-auto flex items-center gap-2 md:gap-3">
                <div className="relative" ref={chatRef}>
                  <button
                    ...
                    className="tikd-chat-btn relative rounded-full bg-neutral-900 p-[9px] ring-1 ring-white/10 transition hover:border-primary-500 hover:ring-primary-500 focus:outline-none focus:ring-primary-500 cursor-pointer"
                  >
                    <div className="flex h-6 w-6 items-center justify-center">
                      <svg
                        ...
                        className="tikd-chat-svg h-5.5 w-5.5 text-[#727293]"
                      >
                ...
                <div className="relative" ref={notifRef}>
                  <button
                    ...
                    className="tikd-notif-btn relative rounded-full bg-neutral-900 p-[9px] ring-1 ring-white/10 transition hover:border-primary-500 hover:ring-primary-500 focus:outline-none focus:ring-primary-500 cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <div className="relative" ref={avatarRef}>
                  <button
                    ...
                    className="flex min-w-0 items-center gap-1.5 rounded-full bg-neutral-900 p-1 sm:min-w-[120px] sm:pr-2 ring-1 ring-white/10 transition hover:ring-primary-500 focus:outline-none focus:ring-primary-500 cursor-pointer"
                  >
                    <div className="relative h-[34px] w-[34px] shrink-0 overflow-hidden rounded-full bg-white/5">
                      <Image
                        src={avatarSrc}
                        width={34}
                        height={34}
                    ...
                    <p className="hidden w-full truncate text-left font-medium capitalize sm:block">
                        ...
                        >
                          ...
                          <div className="p-1.5">
                            ...
                            <button
                              ...
                              className="mt-0.5 flex w-full cursor-pointer items-center gap-2 rounded-lg px-3.5 py-2.5 text-left text-sm text-white/90 hover:bg-white/5 focus:bg-white/5 focus:outline-none"
                            >
            ...
            <div className="flex flex-col gap-3 md:order-1 md:min-w-0 md:flex-row md:items-center md:gap-4">
              <div className="min-w-0 w-full md:max-w-[980px] xl:max-w-[1120px]">
                {searchTrigger}
              </div>

              {showSortSelector ? (
                <div className="w-full md:w-auto">{sortSelector}</div>
              ) : null}
            </div>
          </div>
        </div>
