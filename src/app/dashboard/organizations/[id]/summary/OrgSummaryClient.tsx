...
/* Demo series (MONTHLY) — now “scoped” to org dashboard (same visuals / components) */
...
export default function OrgSummaryClient({ orgId }: { orgId: string }) {
  ...
  return (
    <div className="space-y-5">
      <section className="grid grid-cols-1 rounded-lg border border-neutral-700 bg-neutral-900 lg:grid-cols-[3.15fr_1.74fr] lg:pl-4">
        <KpiCard
          title="Total Revenue"
          value="$240.8K"
          delta="+24.6%"
          accent="from-[#7C3AED] to-[#9333EA]"
          className="px-4 py-5 lg:pr-6 lg:py-5 lg:border-r lg:border-neutral-700"
          stretchChart
        ...
        <div>
          <KpiCard
            ...
            className="p-5 lg:border-b lg:border-neutral-700"
          ...
          <KpiCard
            ...
            value="400"
            valueIcon={
              <Ticket className="h-5 w-5 shrink-0 text-white/90" aria-hidden />
            }
            delta="-24.6%"
            accent="from-[#7C3AED] to-[#9A46FF]"
            className="p-5"
      ...
      <section className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <MyTeamTable
          ...
          onDetailedView={() => {
            // hook later to org members page
          }}
        />
