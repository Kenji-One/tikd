...
function Avatar({
  ...
  if (url) {
    return (
      <img
        ...
        alt={name}
        className={clsx(
          "shrink-0 rounded-sm object-cover ring-1 ring-white/10",
          className ?? "h-5 w-5",
        )}
        loading="lazy"
      />
  ...
  return (
    <div
      aria-hidden
      className={clsx(
        "grid shrink-0 place-items-center font-semibold text-white/90 ring-1 ring-white/10",
...
function MobileStat({
  ...
  return (
    <div className="rounded-xl border border-white/8 bg-white/[0.03] px-3 py-2.5">
      ...
      <div
        className={clsx(
          "mt-1 text-sm font-extrabold tabular-nums text-white",
          valueClassName,
        )}
      >
        {value}
...
export default function MyTeamTable({
  ...
  const thBase =
    "cursor-pointer select-none text-left font-semibold hover:text-white/80";
  const thRow = "[&>th]:px-4 [&>th]:pb-3 [&>th]:pt-1";
    ...
    >
      ...
      {!sorted.length ? (
        <div className="px-4 pb-5 pt-2 text-center">
          <div className="text-sm font-semibold text-white">No members yet</div>
          <div className="mt-1 text-xs text-neutral-400">
            Team members will appear here once data is available.
          </div>
        </div>
      ) : (
        <div
            ...
            {sorted.map((m, i) => {
              ...
              return (
                <div key={m.id ?? m.name}>
                  <div
                    className={clsx(
                      "rounded-2xl border border-white/8 px-3.5 py-3.5",
                      rowBg,
                    )}
                  >
                    <div className="flex items-center gap-3">
                      <Avatar
                        ...
                        bg={m.avatarBg}
                        text={m.avatarText}
                        className="h-10 w-10 rounded-md text-xs"
                      />
            ...
            <table className="w-full border-collapse text-xs font-medium">
              ...
              <thead className="text-neutral-400">
                <tr className={thRow}>
                  ...
                  <th
                    className="cursor-pointer select-none text-right font-medium hover:text-white/80"
                  ...
                  const dataRow = (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-right">
                        <div className="mr-5 inline-flex items-center gap-1.5">
