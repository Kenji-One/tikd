...
function TextBlasterIcon({ className }: IconProps): ReactElement {
  return (
    <svg
      version="1.0"
      xmlns="http://www.w3.org/2000/svg"
...
type IconLike = ((props: IconProps) => ReactElement) | LucideIcon;
...
const DASH_COMING_SOON: Array<{ label: string; icon: IconLike }> = [
  ...
  { label: "Text Blaster (Coming Soon)", icon: TextBlasterIcon },
];
...
export default function Sidebar({
  ...
  }, [isOverlayPinned, toggleCollapsed]);
